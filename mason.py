...
profit = float(os.environ.get("MY_PROFIT", "2088")) # 작년 수익금 등 참고용
...
---
🏁 **목표 달성률**: {achievement_rate:.1f}% (목표 2억 / 현재 {total_budget:,.0f}만)

💰 **총 작전 예산**: {total_budget:,.0f}만 원
  └ 💵 순수 시드: {seed:,.0f}만 원 (수익포함)
  └ 🏦 대출 병력: {debt:,.0f}만 원
...
• 회당 투입액: *{investment_per_turn:,.0f}만 원*
